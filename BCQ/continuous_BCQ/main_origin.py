...
def train_BCQ(state_dim, action_dim, max_action, device, args):
	...
	while training_iters < args.max_timesteps: 
		...
		pol_vals_seq['vae_loss_seq'].append(pol_vals['vae_loss_seq'].mean())
		pol_vals_seq['critic_loss_seq'].append(pol_vals['critic_loss_seq'].mean())
		pol_vals_seq['actor_loss_seq'].append(pol_vals['actor_loss_seq'].mean())

		training_iters += args.eval_freq
		print(f"Training iterations: {training_iters}")

	# plt 绘图
	utils.loss_visualization(pol_vals_seq, 'train', fig_path, training_iters)
	print(f"train loss plt over----------{training_iters}")
	utils.reward_visualization(evaluations, fig_path, training_iters)
